...
#define HWCONF_KEY_NODE DT_NODELABEL(key)
#define HWCONF_THRUSTER_NODE DT_NODELABEL(thruster)
...
#define HWCONF_KEY_PWM_SPEC PWM_DT_SPEC_GET(HWCONF_KEY_NODE)
#define HWCONF_THRUSTER_PWM_SPEC PWM_DT_SPEC_GET(HWCONF_THRUSTER_NODE)

#define HWCONF_KEY_PULSE_0_DEGREE DT_PROP(HWCONF_KEY_NODE, pulse_0_degree_us)
#define HWCONF_KEY_PULSE_180_DEGREE DT_PROP(HWCONF_KEY_NODE, pulse_180_degree_us)

#define HWCONF_THRUSTER_PULSE_0_PERCENT DT_PROP(HWCONF_THRUSTER_NODE, pulse_0_percent_us)
#define HWCONF_THRUSTER_PULSE_100_PERCENT DT_PROP(HWCONF_THRUSTER_NODE, pulse_100_percent_us)
