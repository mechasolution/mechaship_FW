...
#ifndef MECHASHIP_INTERFACES__MSG__DETAIL__TONE__TYPE_SUPPORT_H_
#define MECHASHIP_INTERFACES__MSG__DETAIL__TONE__TYPE_SUPPORT_H_
...
#endif  // MECHASHIP_INTERFACES__MSG__DETAIL__TONE__TYPE_SUPPORT_H_
